...
export function GameNavbar({ playerScore, onProfileClick, onSettingsClick }: GameNavbarProps) {
  ...
  const { isOpen: showChat, openChat, closeChat } = useChatStore();
  ...
  return (
    <>
      ...
      >
        ...
        {/* Game Status - Center */}
        <NavbarContent justify="center" className="gap-2 md:gap-4">
          {/* LIVE/BREAK Chip */}
          <NavbarItem>
            <Chip
          ...
          {/* Question Counter or Timer */}
          <NavbarItem>
            {isSetActive ? (
              <span className="text-sm text-gray-300">
                Q<span className="text-white font-bold text-base">{questionIndex + 1}</span>
          ...
          {/* Score */}
          <NavbarItem>
            <span className={`text-sm font-bold ${playerScore >= 0 ? 'text-green-400' : 'text-red-400'}`}>
