...
export function AuthModal({
  ...
  const [confirmationState, setConfirmationState] = useState<ConfirmationState>({ email: '', password: '' });
  ...
  const handleConfirmRequired = useCallback((email: string, password: string = '') => {
    setConfirmationState({ email, password });
    setAuthStep('confirm');
