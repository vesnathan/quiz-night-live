...
export function SetEndScreen({
  ...
  const { nextSetTime, isSetActive, resetGame, completedQuestions } = useGameStore();
  ...
  const currentPlayerEntry = leaderboard.find((e) => e.userId === currentPlayerId);
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        >
          <Card className={`h-full ${playerRank <= 3 ? 'bg-gradient-to-r from-yellow-900/30 to-orange-900/30 border-2 border-yellow-500' : 'bg-gray-800/50'}`}>
            <CardBody className="p-6 text-center flex flex-col justify-center">
              ...
              <div className={`text-2xl font-bold ${playerScore >= 0 ? 'text-green-400' : 'text-red-400'}`}>
          ...
          >
            <Card className="bg-gray-800/50 h-full">
              <CardBody className="p-4">
                <div className="text-lg text-gray-400 mb-2 text-center">The Podium</div>
                <div className="flex justify-center items-end gap-3 py-4">
                  ...
                  {topThree[1] && (
                    <div className="flex flex-col items-center">
                      ...
                      <div className="text-sm font-bold text-gray-300">
                        {topThree[1].score > 0 ? '+' : ''}{topThree[1].score}
                      </div>
                  ...
                  {topThree[0] && (
                    <div className="flex flex-col items-center">
                      ...
                      <div className="text-base font-bold text-yellow-300">
                        {topThree[0].score > 0 ? '+' : ''}{topThree[0].score}
                      </div>
                  ...
                  {topThree[2] && (
                    <div className="flex flex-col items-center">
                      ...
                      <div className="text-sm font-bold text-gray-300">
                        {topThree[2].score > 0 ? '+' : ''}{topThree[2].score}
                      </div>
          ...
          <Card className="bg-gradient-to-br from-purple-900/30 to-indigo-900/30 border border-purple-500/30">
            <CardBody className="p-6">
              <div className="text-center mb-4">
                <h3 className="text-xl font-bold text-white mb-1">Badges Earned!</h3>
                <p className="text-sm text-gray-400">
                  You earned {uniqueBadgeCount} badge{uniqueBadgeCount !== 1 ? 's' : ''}{earnedBadges.length > uniqueBadgeCount ? ` (${earnedBadges.length} total)` : ''} and{' '}
                  <span className="text-purple-300 font-semibold">+{totalSkillPointsEarned} skill points</span>
                </p>
              </div>
            ...
            <CardBody className="p-4">
              ...
              <Accordion variant="splitted" className="gap-2">
                {completedQuestions.map((q, index) => (
                  <AccordionItem
                    ...
                    title={
                      <div className="flex items-center gap-2">
                        <span className={`text-sm ${q.userCorrect === true ? 'text-green-400' : q.userCorrect === false ? 'text-red-400' : 'text-gray-400'}`}>
                          {q.userCorrect === true ? '✓' : q.userCorrect === false ? '✗' : '–'}
                        </span>
                  ...
                  >
                    <ResearchQuestionItem question={q} questionNumber={index + 1} />
                  </AccordionItem>
                ))}
              </Accordion>
            </CardBody>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className={`font-semibold text-sm truncate ${isCurrentPlayer ? 'text-primary-300' : 'text-white'}`}>
                        {entry.displayName}
      ...
      >
        <Card className="bg-primary-900/30 border border-primary-500/50">
          <CardBody className="p-4 text-center">
            ...
            <div className="text-2xl font-bold text-primary-400">{timeUntilNext}</div>
          </CardBody>
        </Card>
      </motion.div>
